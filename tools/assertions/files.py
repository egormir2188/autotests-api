...
from clients.files.files_schema import FileSchema, GetFileResponseSchema, CreateFileResponseSchema
...
def assert_file(actual: FileSchema, expected: FileSchema):
    ...
    assert_equal(actual.id, actual.id, 'id')
    assert_equal(actual.directory, expected.directory, 'directory')
    assert_equal(expected.filename, expected.filename, 'filename')
    assert_equal(expected.url, expected.url, 'url')
...
@allure.step('Check get non existing file response')
def assert_file_not_found_response(actual: InternalErrorResponseSchema):
    ...
    """
    logger.info('Check get non existing file response')
